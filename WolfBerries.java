...
public class WolfBerries extends Plant {
    ...
    WolfBerries(World world, Cords cords) {
        super(world,cords);
        this.initiative = 0;
        this.power = 99;
    }

    WolfBerries(World world, Cords cords, int age, int initiative, int power) {
    ...
    @Override
    public Color Color() {return new Color(0x06F6F6);}
        ...
        if (chances.size() == 0) return;
            ...
            switch (chances.get(0)) {
                case UP -> {
                    ...
                    world.toAdd(new WolfBerries(world, cords));
                    break;
                }
                case DOWN -> {
                    Cords cords = position;
